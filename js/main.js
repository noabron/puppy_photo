...
function doScreenshot() { 
    ...
    // canvas.getContext('2d').drawImage(imageStickerPupy,95,245,(imageStickerPupy.width*1.5),(imageStickerPupy.height*1.5));
    // canvas.getContext('2d').drawImage(imageStickerPupy,105,90,(260),(220));
    // canvas.getContext('2d').drawImage(imageStickerLogo,-10,310,(340),(200));
    canvas.getContext('2d').drawImage(imageStickerPupy,(canvas.width-390), (canvas.height-305),(170),(140));
    canvas.getContext('2d').drawImage(imageStickerLogo,(canvas.width-475),( canvas.height-120),(235),(130));

    // canvas.getContext('2d').drawImage(imageStickerLogo,-20,350,(imageStickerLogo.width*1.4),(imageStickerLogo.height*1.4));
