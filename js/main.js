...
function doScreenshot() { 
    ...
    const imageStickerPupy = document.querySelector('.pupy');
    ...
    canvas.getContext('2d').drawImage(imageStickerLogo,-30,355,(imageStickerLogo.width*170/100),(imageStickerLogo.height*170/100));
